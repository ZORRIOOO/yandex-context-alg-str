...
В решение я использовал минимальное количество дополнительной памяти, что ограничивает пространственную сложность на O(1).
Это соотвествует условию о том, чтобы реализация сортировки не потребляла O(n) дополнительной памяти для промежуточных данных.
*/
